...
import { AnalysisReport, QuizQuestion, UserAnswer, QuestionType } from '../types';
                        ...
                        <div className="p-6">
                            <div className="flex justify-between items-start mb-4 gap-4">
                                <div className="flex-1">
                                    ...
                                    {questions[index].type === QuestionType.MSQ && (
                                        <span className="text-xs font-medium bg-blue-500/20 text-blue-300 px-2 py-0.5 rounded-full mt-1 inline-block">MSQ</span>
                                    )}
                                </div>
                                {analysis.isCorrect ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 text-sm">
                                ...
                                <div className="bg-slate-900/50 p-3 rounded-lg">
                                    <h4 className="font-bold text-slate-400 mb-1">Your Final Selection</h4>
                                    <div className="text-slate-200">{renderAnswer(userAnswers[index].finalAnswer)}</div>
                                </div>
                                <div className="bg-slate-900/50 p-3 rounded-lg">
                                    <h4 className="font-bold text-slate-400 mb-1">Correct Answer</h4>
                                    <div className="text-slate-200 font-medium">{renderAnswer(questions[index].correctAnswer)}</div>
                                </div>
                            </div>
